        ...
        <Col {...createSpan(12)}>
          <Flex vertical gap={32}>
            ...
            <Typography.Paragraph style={{ fontSize: 18 }}>
              ...
              agile decision-making and proactive adaptation to evolving
              business needs. Boost efficiency, minimize risk, and drive growth
              with unparalleled visibility into your data landscape.
